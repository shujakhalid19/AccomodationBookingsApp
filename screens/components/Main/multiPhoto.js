...
export default class FbImages extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      images: [
        "https://images.unsplash.com/photo-1502005097973-6a7082348e28?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60", 
        "https://images.unsplash.com/photo-1524634126442-357e0eac3c14?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60", 
        ...
        "https://images.unsplash.com/photo-1543789848-067ab85f0e93?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60", 
  ...
  render() {
    ...
    return (
      <View style={[styles.container,this.props.Imstyle]}>
